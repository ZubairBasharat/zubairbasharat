...
*(Generated by the `metrics.yml` workflow in `.github/workflows/` — runs daily. Won't render until the workflow has completed at least one run. Replaces the old `github-readme-stats.vercel.app` badges, whose shared public instance was returning 503s.)*
